...
const AllTask = () => {
   ...
   return (
      <div className='bg-[#1c1c1c] p-5 mt-5 rounded'>
         <div className='bg-purple-900 text-white px-4 py-2 flex justify-between rounded mb-2'>
         ...
         <div className=''>
            {userData.map(function (elem, idx) {
               return <div key={idx} className='border border-gray-300 px-4 py-2 flex justify-between rounded mb-2'>
